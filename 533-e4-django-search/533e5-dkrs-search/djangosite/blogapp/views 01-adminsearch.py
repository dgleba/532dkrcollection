...
class PostListView(generic.ListView):
    ...
    # django  nameerror "AdminSite" is not defined
    # https://stackoverflow.com/questions/63806332/unable-to-override-both-contrib-admin-adminsite-and-django-contrib-auth-admin-us

    adm_model = admin.PostAdmin(models.Post,AdminSite()) 
    changelist = None        
