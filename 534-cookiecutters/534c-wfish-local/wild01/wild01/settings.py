...
class Common(Configuration):
    ...
    WSGI_APPLICATION = "wild01.wsgi.application"
...
class Deployed(RedisCache, Common):
    ...
    def post_setup(cls):
        ...
        sentry_sdk.init(
            dsn="", integrations=[DjangoIntegration()], environment=CONFIGURATION,
        )
