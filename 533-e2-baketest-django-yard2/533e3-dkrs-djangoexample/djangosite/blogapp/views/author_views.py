...
class AuthorCreateView(CreateView):
    ...
    def get_success_url(self):
        return reverse("blogapp:author_detail", args=(self.object.pk,))
...
class AuthorUpdateView(UpdateView):
    ...
    form_class = AuthorForm
    # fields = ['name']
    template_name = "blogapp/author_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class AuthorDeleteView(DeleteView):
    model = Author
    template_name = "blogapp/author_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "author"
    ...
    def get_success_url(self):
        return reverse("blogapp:author_list")
